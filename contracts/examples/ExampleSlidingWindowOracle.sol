...
import '../libraries/BotdexOracleLibrary.sol';
...
contract ExampleSlidingWindowOracle {
    ...
    function update(address tokenA, address tokenB) external {
        unchecked {
            ...
            if (timeElapsed > periodSize) {
                (uint price0Cumulative, uint price1Cumulative,) = BotdexOracleLibrary.currentCumulativePrices(pair);
    ...
    function consult(address tokenIn, uint amountIn, address tokenOut) external view returns (uint amountOut) {
        address pair = BotdexLibrary.pairFor(factory, tokenIn, tokenOut);
        ...
        unchecked {
            ...
            (uint price0Cumulative, uint price1Cumulative,) = BotdexOracleLibrary.currentCumulativePrices(pair);
            (address token0,) = BotdexLibrary.sortTokens(tokenIn, tokenOut);
